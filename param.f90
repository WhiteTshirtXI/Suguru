...
!******************************************************************************************************************************
real,parameter :: col=.01421333,betacol=15.36,rad0=2.5*dz!col is non dimensional Beta*De in the Morse potential model for
!interaction with wall, betacol is non dimensional Beta, rad0 is zero force distance
!******************************************************************************************************************************
!****************************************************particle parameters*******************************************************
!******************************************************************************************************************************
